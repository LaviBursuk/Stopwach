...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppClientServicesStopwatchServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function StopwatchService(http) {
    ...
    StopwatchService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    StopwatchService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], StopwatchService);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_main_page_mainPage_component__WEBPACK_IMPORTED_MODULE_5__["MainPageComponent"]],
  ...
  function srcAppMainPageMainPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ClientServices_stopwatch_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../ClientServices/stopwatch.service */
    "./src/app/ClientServices/stopwatch.service.ts");
    /* harmony import */


    var _Models_Time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../Models/Time */
    "./src/app/Models/Time.ts");
    ...
    function () {
      ...
      _createClass(MainPageComponent, [{
        ...
        value: function refreshTimes() {
          ...
          this.service.getAllTimes().subscribe(function (data) {
            _this.allTimes = data;

            _this.allTimes.sort(function (a, b) {
        ...
        value: function startTimer() {
          ...
          if (this.isRunning) {
            ...
            var startTime = Date.now() - this.counter;
            this.timerInterval = setInterval(function () {
              _this2.counter = Date.now() - startTime;
              _this2.displayTime = _this2.calcRealTime(_this2.counter);
            });
          } else {
            this.playButtonText = 'Play';
            clearInterval(this.timerInterval);
        ...
        key: "calcRealTime",
        value: function calcRealTime(counter) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Lavi\Projects\spring\Stopwatch\client\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
